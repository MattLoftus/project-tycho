...
const REGIONS = {
  ...
  santorini: {
    label:    'SANTORINI',
    subtitle: 'CYCLADES · AEGEAN SEA · GREECE',
    z: 12, baseX: 2337, baseY: 1526, grid: 4,
    satZ: 14,
    sceneH: 22,
    blurRadius: 2,
    features: [
      ...
      { name: 'Oia',             type: 'Village',  lat: 36.462, lon: 25.376, depth: '---', width: '---'     },
      { name: 'Fira',            type: 'Village',  lat: 36.416, lon: 25.432, depth: '---', width: '---'     },
      { name: 'Ancient Thera',   type: 'Ruins',    lat: 36.360, lon: 25.470, depth: '---', width: '396 m'   },
      { name: 'Red Beach',       type: 'Coast',    lat: 36.348, lon: 25.390, depth: '---', width: '---'     },
    ],
  },
  borabora: {
    label:    'BORA BORA',
    subtitle: 'LEEWARD ISLANDS · FRENCH POLYNESIA',
    z: 12, baseX: 321, baseY: 2233, grid: 4,
    satZ: 14,
    sceneH: 18,
    blurRadius: 2,
    features: [
      ...
      { name: 'Coral Lagoon',     type: 'Lagoon',  lat: -16.510, lon: -151.755, depth: '---', width: '---'     },
      { name: 'Barrier Reef',     type: 'Reef',    lat: -16.475, lon: -151.775, depth: '---', width: '---'     },
      { name: 'Motu Tapu',        type: 'Islet',   lat: -16.480, lon: -151.780, depth: '---', width: '---'     },
      { name: 'Faanui Bay',       type: 'Coast',   lat: -16.485, lon: -151.750, depth: '---', width: '---'     },
    ],
  },
  namibia: {
    label:    'NAMIB DESERT',
    subtitle: 'SOSSUSVLEI · NAMIBIA',
    z: 11, baseX: 1111, baseY: 1179, grid: 4,
    satZ: 13,
    sceneH: 20,
    blurRadius: 3,
    features: [
      ...
      { name: 'Deadvlei',           type: 'Pan',    lat: -24.762, lon: 15.292, depth: '---', width: '---'     },
      { name: 'Big Daddy Dune',     type: 'Dune',   lat: -24.760, lon: 15.295, depth: '---', width: '325 m'  },
      { name: 'Tsauchab River',     type: 'River',  lat: -24.72,  lon: 15.40,  depth: '---', width: '---'     },
      { name: 'Naukluft Mountains', type: 'Range',  lat: -24.25,  lon: 16.00,  depth: '---', width: '1,965 m'},
    ],
  },
  fuji: {
    label:    'MOUNT FUJI',
    subtitle: 'SHIZUOKA / YAMANASHI · JAPAN',
    z: 12, baseX: 3627, baseY: 1541, grid: 4,
    satZ: 14,
    sceneH: 32,
    blurRadius: 2,
    features: [
      ...
      { name: 'Lake Kawaguchi',     type: 'Lake',    lat: 35.515, lon: 138.750, depth: '---', width: '---'     },
      { name: 'Lake Yamanaka',     type: 'Lake',    lat: 35.415, lon: 138.870, depth: '---', width: '---'     },
      { name: 'Yoshida Trail',     type: 'Route',   lat: 35.380, lon: 138.740, depth: '---', width: '---'     },
      { name: 'Aokigahara Forest', type: 'Forest',  lat: 35.470, lon: 138.620, depth: '---', width: '---'     },
    ],
  },
  cappadocia: {
    label:    'CAPPADOCIA',
    subtitle: 'CENTRAL ANATOLIA · TURKEY',
    z: 12, baseX: 2443, baseY: 1482, grid: 4,
    satZ: 14,
    sceneH: 26,
    blurRadius: 2,
    features: [
      ...
      { name: 'Mount Erciyes',     type: 'Volcano', lat: 38.532, lon: 35.447, depth: '---', width: '3,917 m' },
      { name: 'Devrent Valley',    type: 'Valley',  lat: 38.660, lon: 34.860, depth: '---', width: '---'     },
      { name: 'Ihlara Canyon',     type: 'Canyon',  lat: 38.270, lon: 34.300, depth: '---', width: '100 m'   },
      { name: 'Derinkuyu',         type: 'Ruins',   lat: 38.372, lon: 34.733, depth: '---', width: '---'     },
    ],
  },
}
